...
-   Boxplots for overall_survival_months against each radio therapy class are extremely similar, including the mean and median values.
...
-   Those that died from disease have significantly lower overall_survival_months values than all other categories and the most extreme outliers, while those that died from other causes have a lower mean and median overall_survival_months than those that lived.
...
-   The histogram for those that died from disease is significantly skewed to the right, while the histogram for those that lived is significantly skewed to the left.
